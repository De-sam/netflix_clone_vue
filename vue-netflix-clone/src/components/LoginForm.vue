...
.background-overlay {
  ...
  width: 100%;
  height: 100%;
  background: rgba(0, 0, 0, 0.6); /* Transparent overlay for desktop */
  z-index: 1;
}
...
.login-container {
  ...
  transform: translateY(-30px); /* Moved up for desktop */
  z-index: 2;
}
...
@media (max-width: 600px) {
  ...
  .login-container {
    transform: translateY(-30px); /* Shifted up to reduce gap to logo */
  }

  .login-card {
    padding: 1rem 1rem; /* Reduced top padding for compact mobile layout */
    max-width: 90%;
  }
}
</style>
